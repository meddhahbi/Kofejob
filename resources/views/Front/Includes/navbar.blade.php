<header class="header">
    <nav class="navbar navbar-expand-lg header-nav">
        ...
        <ul class="nav header-navbar-rht reg-head">
            {{-- @if (!$rememberToken) --}}
            <li><a href="{{ route('register') }}" class="reg-btn"><img src="Assets/img/icon/reg-icon.svg" class="me-1"
                        alt="icon"> Register</a></li>
            <li><a href="{{ route('login') }}" class="log-btn"><img src="Assets/img/icon/lock-icon.svg" class="me-1"
                        alt="icon"> Login</a></li>
                        {{-- @else --}}
