...
<!-- Mirrored from kofejob.dreamguystech.com/template/freelancer-ongoing-projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 20:21:10 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="settings-widget">
                        <div class="settings-header d-sm-flex flex-row flex-wrap text-center text-sm-start align-items-center">
                            ...
                            <div class="ms-sm-3 ms-md-0 ms-lg-3 mt-2 mt-sm-0 mt-md-2 mt-lg-0">
                                ...
                                <h3 class="mb-0"><a href="freelancer-profile.html">George Wells</a></h3>
                ...
                <div class="col-xl-9 col-md-8">
                    ...
                    <nav class="user-tabs mb-4">
                        <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                            <li class="nav-item">
                                <a class="nav-link" href="freelancer-project-proposals.html">My Proposals</a>
                            </li>
                            <li class="nav-item">
                                        ...
                                        <div class="projects-details align-items-center">
                                            ...
                                            <div class="project-hire-info project">
                                                ...
                                                <div class="projects-action text-start project">
                                                    <a href="freelancer-view-project-detail.html" class="projects-btn project">View Details </a>
...
<!-- Mirrored from kofejob.dreamguystech.com/template/freelancer-ongoing-projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 20:21:11 GMT -->
</html>
