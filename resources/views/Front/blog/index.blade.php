...
{{--<!-- Mirrored from kofejob.dreamguystech.com/template/blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 20:20:48 GMT -->--}}
{{--<head>--}}
{{--<meta charset="UTF-8">--}}
...
<a href="{{ route('DetailsBlog', $b->id) }}"><img src="{{ asset('uploads/' . $b->image) }}" alt="Blog Image" height="100" width="100"></a>
</div>
...
<h3 class="blog-title"><a href="blog-details.html">{{ $b->titre }}</a></h3>
<p class="mb-0">{{ $b->description }}</p>
</div>
<a href="{{ route('EditBlog', $b->id) }}" class="btn btn-warning">Modifier</a>
                        <form action="{{ route('DestroyBlog', $b->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
...
{{--<!-- Mirrored from kofejob.dreamguystech.com/template/blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 20:20:49 GMT -->--}}
{{--</html>--}}
